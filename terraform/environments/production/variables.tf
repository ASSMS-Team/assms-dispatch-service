...
variable "vm_name" {
  description = "Name of the Dispatch Service VM."
  type        = string
  default     = "vm-assms-dispatch-production"
}
variable "vm_size" {
...
variable "nsg_name" {
  ...
  type        = string
  default     = "nsg-assms-dispatch-production"
}
variable "nic_name" {
  description = "Name of the service NIC."
  type        = string
  default     = "nic-assms-dispatch-production"
}
variable "public_ip_name" {
  description = "Name of the optional service public IP."
  type        = string
  default     = "pip-assms-dispatch-production"
}
